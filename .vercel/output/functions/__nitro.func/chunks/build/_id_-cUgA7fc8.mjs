import { defineComponent, computed, mergeProps, ref, watch, unref, nextTick, useSSRContext } from 'vue';
...
import { g as useRoute$1, a as useRouter, c as useAuthStore, b as useNuxtApp, e as __nuxt_component_0$1 } from './server.mjs';
import { u as useGroupsStore } from './useGroups-Cakde6q0.mjs';
import { u as usePresence } from './usePresence-Cj_cq230.mjs';
import { defineStore } from 'pinia';
import { u as useFriendsStore } from './useFriends-Bggh7amy.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { a as useMessagesStore, u as useWebSocket, b as formatDateForSeparator, e as eventBus, f as formatMessageTimestamp, _ as __nuxt_component_0 } from './OptimizedAvatar-B-2OddAN.mjs';
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.isOpen) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 flex items-start justify-center pt-20 bg-black bg-opacity-30 z-50" }, _attrs))}><div class="bg-white rounded-lg shadow-lg overflow-hidden w-full max-w-md"><div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center"><div class="flex flex-1 items-center"><div class="relative flex-1"><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:search",
          class: "h-4 w-4 text-gray-400"
        }, null, _parent));
        _push(`</div><input type="text"${ssrRenderAttr("value", searchQuery.value)} placeholder="Search Messages" class="w-full text-black pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"></div><button class="${ssrRenderClass(`ml-3 p-2 rounded-full ${filtersApplied.value ? "bg-blue-500 text-white" : "hover:bg-gray-100 text-gray-500"}`)}">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:filter",
          class: "h-4 w-4"
        }, null, _parent));
        ...
        if (showFilter.value) {
          ...
          _push(`</button></div><div class="px-6 py-4"><p class="text-sm text-gray-500 mb-4">${ssrInterpolate(filtersApplied.value ? "Filters Applied" : "No Filters Applied")}</p><div class="relative mb-4"><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "fa:search",
            class: "h-4 w-4 text-gray-400"
          }, null, _parent));
          _push(`</div><input type="text"${ssrRenderAttr("value", memberSearchQuery.value)} placeholder="Search by name" class="w-full text-black pl-10 py-2 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none"></div><div class="mt-2 max-h-60 overflow-y-auto"><!--[-->`);
          ssrRenderList(groupedMembers.value, (members, letter) => {
            _push(`<div><div class="mb-2 text-xs text-gray-500">${ssrInterpolate(letter)}</div><!--[-->`);
            ssrRenderList(members, (member) => {
              ...
              if (member.avatar) {
                _push(`<img${ssrRenderAttr("src", member.avatar)}${ssrRenderAttr("alt", member.name)} class="w-full h-full object-cover">`);
              } else {
                _push(ssrRenderComponent(_component_Icon, {
                  name: "fa:user",
                  class: "h-5 w-5 text-gray-500"
              ...
              _push(`</div><span>${ssrInterpolate(member.name)}</span></div><input type="checkbox"${ssrIncludeBooleanAttr(selectedMembers.value.includes(member.id)) ? " checked" : ""} class="h-5 w-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500"></div>`);
            });
            _push(`<!--]--></div>`);
          });
          _push(`<!--]-->`);
          ...
          if (filtersApplied.value) {
            _push(`<div class="px-4 py-2 bg-blue-50 flex items-center rounded mb-4"><span class="mr-2 text-sm text-blue-700">${ssrInterpolate(selectedMembers.value.length)} ${ssrInterpolate(selectedMembers.value.length === 1 ? "person" : "people")} added to the filter </span><button class="ml-auto text-blue-700 hover:text-blue-800"> Clear </button></div>`);
          } else {
            _push(`<!---->`);
          }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.groupDetails.avatar_url) {
        _push(`<img${ssrRenderAttr("src", _ctx.groupDetails.avatar_url)}${ssrRenderAttr("alt", _ctx.groupDetails.name)} class="h-full w-full object-cover" data-v-6eb20b78>`);
      } else {
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:users",
      ...
      _push(`</div><h2 class="text-xl text-black font-semibold" data-v-6eb20b78>${ssrInterpolate(groupName.value)}</h2><p class="text-gray-500 text-sm" data-v-6eb20b78>${ssrInterpolate(_ctx.groupDetails.description)}</p></div></div><div class="border-b border-gray-200" data-v-6eb20b78><div class="p-4 flex justify-between items-center cursor-pointer" data-v-6eb20b78><div class="flex items-center" data-v-6eb20b78><h3 class="font-medium text-black" data-v-6eb20b78> Members <span class="text-gray-500" data-v-6eb20b78> (${ssrInterpolate(_ctx.groupDetails.memberCount)}) </span></h3></div><div class="text-gray-500 text-sm" data-v-6eb20b78>${ssrInterpolate(expandedSection.value === "members" ? "\u25B2" : "\u25BC")}</div></div>`);
      if (expandedSection.value === "members") {
        ...
        if (blockedMembersCount.value > 0) {
          ...
          _push(`<span class="text-sm font-medium" data-v-6eb20b78>${ssrInterpolate(blockedMembersCount.value)} member${ssrInterpolate(blockedMembersCount.value > 1 ? "s" : "")} blocked </span></div><p class="text-xs text-red-600 mt-1" data-v-6eb20b78> Blocked members cannot send or receive messages in this group </p></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        ssrRenderList(membersWithStatus.value, (member) => {
          _push(`<div class="${ssrRenderClass(`flex items-center justify-between p-2 rounded-lg transition-all duration-200 ${member.isBlocked ? "bg-red-50 border border-red-200" : "hover:bg-gray-50"}`)}" data-v-6eb20b78><div class="flex items-center" data-v-6eb20b78><div class="relative mr-3" data-v-6eb20b78><div class="${ssrRenderClass(`w-8 h-8 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center ${member.isBlocked ? "opacity-60 grayscale" : ""}`)}" data-v-6eb20b78>`);
          if (member.avatar) {
            _push(`<img${ssrRenderAttr("src", member.avatar)}${ssrRenderAttr("alt", member.name)} class="w-full h-full object-cover" data-v-6eb20b78>`);
          } else {
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:user",
          ...
          if (!member.isBlocked) {
            _push(`<div class="${ssrRenderClass(`absolute bottom-0 right-0 h-2 w-2 rounded-full border border-white ${member.presenceStatus === "online" ? "bg-green-500" : member.presenceStatus === "busy" ? "bg-red-500" : member.presenceStatus === "away" ? "bg-yellow-500" : "bg-gray-400"}`)}" data-v-6eb20b78></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="flex flex-col" data-v-6eb20b78><div class="flex items-center gap-2" data-v-6eb20b78><span class="${ssrRenderClass(`text-sm font-medium ${member.isBlocked ? "text-gray-500 line-through" : "text-black"}`)}" data-v-6eb20b78>${ssrInterpolate(member.name)}</span>`);
          if (member.isBlocked) {
          ...
          if (!member.isBlocked) {
            ...
            if (member.presenceStatus === "online") {
              ...
              _push(`<span class="text-xs text-gray-500" data-v-6eb20b78>${ssrInterpolate(member.lastActive)}</span>`);
            }
            _push(`</div>`);
          } else {
            _push(`<!---->`);
          ...
          _push(`</div></div><div class="relative" data-v-6eb20b78><button class="${ssrRenderClass(`p-1 rounded-full transition-colors ${member.isBlocked ? "text-red-400 hover:text-red-600 hover:bg-red-100" : "text-gray-400 hover:text-gray-600 hover:bg-gray-100"}`)}" data-v-6eb20b78>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "fa:ellipsis-v",
            class: "h-3 w-3"
          }, null, _parent));
          ...
          if (activeDropdown.value === member.id) {
            _push(`<div class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10 overflow-hidden" data-v-6eb20b78><button class="${ssrRenderClass(`flex w-full text-left px-4 py-3 text-sm items-center transition-colors ${member.isBlocked ? "hover:bg-green-50 text-green-700" : "hover:bg-red-50 text-red-700"}`)}"${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""} data-v-6eb20b78>`);
            if (member.isBlocked) {
              _push(ssrRenderComponent(_component_Icon, {
                name: "fa:check",
            ...
            _push(`<div class="flex flex-col" data-v-6eb20b78><span class="${ssrRenderClass(`font-medium ${member.isBlocked ? "text-green-700" : "text-red-700"}`)}" data-v-6eb20b78>${ssrInterpolate(member.isBlocked ? "Unblock User" : "Block User")}</span><span class="${ssrRenderClass(`text-xs ${member.isBlocked ? "text-green-600" : "text-red-600"}`)}" data-v-6eb20b78>${ssrInterpolate(member.isBlocked ? "Allow messages again" : "Stop receiving messages")}</span></div>`);
            if (isLoading.value) {
      ...
      _push(`</div><div class="border-b border-gray-200" data-v-6eb20b78><div class="p-4 flex justify-between items-center cursor-pointer" data-v-6eb20b78><div class="flex items-center" data-v-6eb20b78><h3 class="font-medium text-black" data-v-6eb20b78> Attachments <span class="text-gray-500" data-v-6eb20b78> (${ssrInterpolate(attachments.value.length)}) </span></h3></div><div class="text-gray-500 text-sm" data-v-6eb20b78>${ssrInterpolate(expandedSection.value === "attachments" ? "\u25B2" : "\u25BC")}</div></div>`);
      if (expandedSection.value === "attachments") {
        ...
        if (isLoading.value) {
          ...
          ssrRenderList(displayedAttachments.value, (attachment) => {
            ...
            if (isImage(attachment.mime_type)) {
              _push(`<img${ssrRenderAttr("src", attachment.url)}${ssrRenderAttr("alt", attachment.filename)} class="w-full h-full object-cover" data-v-6eb20b78>`);
            } else {
            ...
            _push(`</div><div class="flex-1 min-w-0" data-v-6eb20b78><p class="text-sm font-medium text-gray-900 truncate" data-v-6eb20b78>${ssrInterpolate(attachment.filename)}</p><div class="flex items-center space-x-2 text-xs text-gray-500" data-v-6eb20b78><span data-v-6eb20b78>${ssrInterpolate(unref(formatFileSize)(attachment.size))}</span><span data-v-6eb20b78>\u2022</span><span data-v-6eb20b78>${ssrInterpolate(formatDate(attachment.uploaded_at))}</span></div></div><div class="flex items-center space-x-1" data-v-6eb20b78><button class="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-50 rounded-lg transition-colors" title="Download" data-v-6eb20b78>`);
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:download",
              class: "h-4 w-4"
            }, null, _parent));
          ...
          if (hasMoreAttachments.value) {
            _push(`<div class="text-center pt-2" data-v-6eb20b78><button class="px-4 py-2 text-sm text-blue-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" data-v-6eb20b78> View All (${ssrInterpolate(attachments.value.length)}) </button></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      if (showAttachmentsModal.value) {
        ...
        _push(`</button></div><div class="overflow-y-auto p-4" style="${ssrRenderStyle({ "max-height": "calc(90vh - 8rem)" })}" data-v-6eb20b78>`);
        ...
        if (pagination.value.has_more_pages) {
          _push(`<div class="flex justify-center mt-4" data-v-6eb20b78><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:bg-gray-300"${ssrIncludeBooleanAttr(isLoadingMore.value) ? " disabled" : ""} data-v-6eb20b78>${ssrInterpolate(isLoadingMore.value ? "Loading..." : "Load More")}</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      ...
      if (showShareModal.value) {
        ...
        ssrRenderList(friendsList.value, (friend) => {
          _push(`<div class="${ssrRenderClass(`flex items-center justify-between p-3 border-b border-gray-100 cursor-pointer hover:bg-gray-50 ${friend.shareSelected ? "bg-blue-50" : ""}`)}" data-v-6eb20b78><div class="flex items-center" data-v-6eb20b78><div class="w-8 h-8 rounded-full overflow-hidden bg-gray-200 mr-2 flex items-center justify-center" data-v-6eb20b78>`);
          if (friend.avatar) {
            _push(`<img${ssrRenderAttr("src", friend.avatar)}${ssrRenderAttr("alt", friend.name)} class="h-full w-full object-cover" data-v-6eb20b78>`);
          } else {
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:user",
              class: "h-4 w-4 text-gray-500"
          ...
          _push(`</div><span class="text-sm" data-v-6eb20b78>${ssrInterpolate(friend.name)}</span></div>`);
        ...
        _push(`<!--]--></div></div><div class="flex justify-end" data-v-6eb20b78><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(!friendsList.value.some((friend) => friend.shareSelected)) ? " disabled" : ""} data-v-6eb20b78> Share </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showPreview.value) {
        ...
        if (selectedAttachment.value) {
          ...
          if (isImage(selectedAttachment.value.mime_type)) {
            _push(`<img${ssrRenderAttr("src", selectedAttachment.value.url)}${ssrRenderAttr("alt", selectedAttachment.value.filename)} class="max-h-[80vh] max-w-full object-contain" data-v-6eb20b78>`);
          } else {
            ...
            _push(`<p class="text-lg font-medium text-gray-900 mb-2" data-v-6eb20b78>${ssrInterpolate(selectedAttachment.value.filename)}</p><p class="text-gray-500 mb-4" data-v-6eb20b78>${ssrInterpolate(unref(formatFileSize)(selectedAttachment.value.size))}</p><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" data-v-6eb20b78>`);
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:download",
              class: "h-4 w-4 mr-2"
            }, null, _parent));
      ...
      if (showAddMemberPopup.value) {
        ...
        _push(`<input type="text" placeholder="Search friends..."${ssrRenderAttr("value", searchQuery.value)} class="w-full pl-10 pr-3 py-2 text-black border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-6eb20b78></div><div class="max-h-60 overflow-y-auto mb-4 border border-gray-200 rounded-lg" data-v-6eb20b78>`);
        if (filteredFriends.value.length === 0) {
          ...
          ssrRenderList(filteredFriends.value, (friend) => {
            ...
            _push(`</div><div data-v-6eb20b78><p class="font-medium text-sm text-black" data-v-6eb20b78>${ssrInterpolate(friend.name)}</p><p class="text-gray-700 text-xs" data-v-6eb20b78>@${ssrInterpolate(friend.username)}</p></div></div>`);
            if (friend.selected) {
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isDefinitelyCurrentUser.value) {
        _push(`<div class="${ssrRenderClass(`text-xs text-gray-600 mb-1 font-medium ml-1 transition-colors duration-200 hover:text-gray-800`)}" data-v-2ff1d7b6>${ssrInterpolate(((_e = _ctx.message.sender) == null ? void 0 : _e.name) || "Unknown User")} `);
        if ((_f = _ctx.message.sender) == null ? void 0 : _f.role) {
          _push(`<span class="ml-1 text-gray-400 lowercase" data-v-2ff1d7b6> \u2022 ${ssrInterpolate(_ctx.message.sender.role)}</span>`);
        } else {
          _push(`<!---->`);
        }
        if ((_g = _ctx.message.sender) == null ? void 0 : _g.customTitle) {
          _push(`<span class="ml-1 text-blue-500 text-xs" data-v-2ff1d7b6> \u2022 ${ssrInterpolate(_ctx.message.sender.customTitle)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="${ssrRenderClass(getMessageBubbleClasses.value)}"${ssrRenderAttr("title", getMessageTitle.value)}${ssrRenderAttr("data-testid", `message-${_ctx.message.id}`)} data-v-2ff1d7b6>`);
      ...
      if (_ctx.message.attachment) {
        ...
        if (_ctx.message.attachment.type === "image") {
          _push(`<div class="relative" data-v-2ff1d7b6><img${ssrRenderAttr("src", _ctx.message.attachment.url)}${ssrRenderAttr("alt", _ctx.message.attachment.name)} class="max-w-full h-auto rounded-lg cursor-pointer hover:opacity-90 transition-opacity" data-v-2ff1d7b6><div class="absolute bottom-2 right-2 bg-black bg-opacity-50 text-white text-xs px-2 py-1 rounded" data-v-2ff1d7b6>${ssrInterpolate(_ctx.message.attachment.size)}</div></div>`);
        } else {
          ...
          _push(`<div class="flex-1 min-w-0" data-v-2ff1d7b6><p class="text-sm font-medium text-gray-900 truncate" data-v-2ff1d7b6>${ssrInterpolate(_ctx.message.attachment.name)}</p><p class="text-xs text-gray-500" data-v-2ff1d7b6>${ssrInterpolate(_ctx.message.attachment.size)}</p></div><button class="ml-3 p-2 text-gray-500 hover:text-blue-500 transition-colors" data-v-2ff1d7b6>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "fa:download",
            class: "h-4 w-4"
          }, null, _parent));
      ...
      _push(`<div class="${ssrRenderClass(messageContentClasses.value)}" data-v-2ff1d7b6>`);
      if (_ctx.message.isDeleted) {
        ...
        _push(`<!--[-->${ssrInterpolate(_ctx.message.content)}<!--]-->`);
      }
      ...
      if (_ctx.message.reactions && _ctx.message.reactions.length > 0) {
        ...
        ssrRenderList(_ctx.message.reactions, (reaction) => {
          _push(`<div class="${ssrRenderClass([{ "bg-blue-100 text-blue-700": reaction.hasReacted }, "inline-flex items-center px-2 py-1 rounded-full text-xs bg-gray-100 hover:bg-gray-200 cursor-pointer transition-colors"])}" data-v-2ff1d7b6><span class="mr-1" data-v-2ff1d7b6>${ssrInterpolate(reaction.emoji)}</span><span class="font-medium" data-v-2ff1d7b6>${ssrInterpolate(reaction.count)}</span></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="flex items-center space-x-1.5 text-xs" data-v-2ff1d7b6><span class="${ssrRenderClass(`font-medium ${isDefinitelyCurrentUser.value ? "text-blue-100" : "text-gray-500"}`)}" data-v-2ff1d7b6>${ssrInterpolate(formatTimestamp(_ctx.message.timestamp))}</span>`);
      if (isDefinitelyCurrentUser.value) {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="min-w-0 flex-1" data-v-6c1ff8b1><h2 class="font-semibold text-gray-800 text-lg truncate" data-v-6c1ff8b1>${ssrInterpolate(((_c = currentGroup.value) == null ? void 0 : _c.name) || "Loading...")}</h2><p class="text-xs sm:text-sm text-gray-500 truncate" data-v-6c1ff8b1>${ssrInterpolate(memberCount.value)} member${ssrInterpolate(memberCount.value !== 1 ? "s" : "")} `);
      if (groupMembers.value.filter(
        (m) => getMemberStatus(m.user_id) === "online"
      ).length > 0) {
        _push(`<span class="ml-1" data-v-6c1ff8b1> \xB7 ${ssrInterpolate(groupMembers.value.filter(
          (m) => getMemberStatus(m.user_id) === "online"
        ).length)} online </span>`);
      } else {
        _push(`<!---->`);
      ...
      _push(`</button><button class="${ssrRenderClass([{ "bg-blue-50 text-blue-500": showInfo.value }, "p-2 rounded-lg text-gray-500 hover:bg-gray-100 hover:text-blue-500 transition-colors duration-200"])}" title="Group info" data-v-6c1ff8b1>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "fa:info-circle",
        class: "h-4 w-4"
      }, null, _parent));
      ...
      if (canLoadMoreMessages.value && displayMessages.value.length > 0) {
        _push(`<div class="text-center mb-6" data-v-6c1ff8b1><button class="${ssrRenderClass([{ "opacity-50 cursor-not-allowed": isLoadingMore.value }, "inline-flex items-center px-4 py-2 text-sm bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition-colors border border-gray-200 shadow-sm"])}"${ssrIncludeBooleanAttr(isLoadingMore.value) ? " disabled" : ""} data-v-6c1ff8b1>`);
        if (isLoadingMore.value) {
      ...
      _push(`<!--[-->`);
      ssrRenderList(displayMessages.value, (message) => {
        _push(`<div class="message-wrapper" data-v-6c1ff8b1>`);
        _push(ssrRenderComponent(GroupMessageItem, {
          message: {
            ...message,
      ...
      if (isUploading.value && uploadProgress.value.length > 0) {
        ...
        _push(` Uploading ${ssrInterpolate(uploadProgress.value.length)} file${ssrInterpolate(uploadProgress.value.length > 1 ? "s" : "")}... </div><div class="space-y-3" data-v-6c1ff8b1><!--[-->`);
        ssrRenderList(uploadProgress.value, (progress) => {
          ...
          _push(`<span class="text-sm font-medium text-gray-900 truncate" data-v-6c1ff8b1>${ssrInterpolate(progress.file.name)}</span></div><div class="flex items-center space-x-2" data-v-6c1ff8b1><span class="text-xs text-gray-500" data-v-6c1ff8b1>${ssrInterpolate(progress.progress)}%</span><div class="w-4 h-4" data-v-6c1ff8b1>`);
          ...
          _push(`</div></div></div><div class="w-full bg-gray-200 rounded-full h-2" data-v-6c1ff8b1><div style="${ssrRenderStyle({ width: `${progress.progress}%` })}" class="${ssrRenderClass([{
          ...
          if (progress.error) {
            ...
            _push(` ${ssrInterpolate(progress.error)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      _push(`<div class="flex items-end space-x-3" data-v-6c1ff8b1><div class="relative" data-v-6c1ff8b1><button class="${ssrRenderClass([{ "bg-blue-100 text-blue-600": isAttachmentMenuOpen.value }, "p-2.5 rounded-full text-gray-500 hover:bg-gray-100 hover:text-blue-500 transition-colors duration-200"])}" title="Attach file"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-6c1ff8b1>`);
      ...
      if (isAttachmentMenuOpen.value) {
        _push(`<div class="absolute bottom-12 left-0 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-10 animate-fadeIn" style="${ssrRenderStyle({ "min-width": "180px" })}" data-v-6c1ff8b1><button type="button"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} class="${ssrRenderClass([{
        ...
        _push(`</button><button type="button"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} class="${ssrRenderClass([{
          "opacity-50 cursor-not-allowed": isSending.value || isUploading.value
      ...
      _push(`</div><input type="file" class="hidden" multiple${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-6c1ff8b1><input type="file" accept="image/*" class="hidden" multiple${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-6c1ff8b1><div class="flex-1 relative" data-v-6c1ff8b1><input${ssrRenderAttr("value", inputMessage.value)} type="text"${ssrRenderAttr(
        "placeholder",
        editingMessageId.value ? "Edit your message..." : "Type your message..."
      )} class="w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-full focus:outline-none focus:border-blue-400 focus:bg-white text-gray-700 transition-colors duration-200"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-6c1ff8b1></div><button${ssrIncludeBooleanAttr(
      ...
      if (showInfo.value) {
        _push(ssrRenderComponent(GroupInfoPanel, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.isOpen) {
        ...
        _push(`</div><input type="text"${ssrRenderAttr("value", searchQuery.value)} placeholder="Search Messages" class="w-full text-black pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"></div><button class="ml-2 p-2 hover:bg-gray-100 rounded-full">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:times",
          size: "20",
          class: "text-gray-500"
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a = _ctx.friendDetails) == null ? void 0 : _a.avatar) || ((_b = _ctx.friendDetails) == null ? void 0 : _b.profile_picture_url)) {
        _push(`<img${ssrRenderAttr("src", _ctx.friendDetails.avatar || _ctx.friendDetails.profile_picture_url)}${ssrRenderAttr("alt", _ctx.friendDetails.name)} class="h-full w-full object-cover" data-v-c54c0065>`);
      } else {
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:user",
          class: "h-12 w-12 text-gray-400"
      ...
      _push(`</div><h2 class="text-black text-xl font-semibold text-center" data-v-c54c0065>${ssrInterpolate(displayName.value)}</h2><p class="text-gray-500 text-sm" data-v-c54c0065> @${ssrInterpolate(((_c = _ctx.friendDetails) == null ? void 0 : _c.username) || ((_d = _ctx.friendDetails) == null ? void 0 : _d.name) || "user")}</p><div class="flex items-center space-x-2 mt-2" data-v-c54c0065><div class="${ssrRenderClass(`w-3 h-3 rounded-full ${((_e = _ctx.friendDetails) == null ? void 0 : _e.status) === "online" ? "bg-green-500" : "bg-gray-400"}`)}" data-v-c54c0065></div><span class="text-sm text-gray-600 capitalize" data-v-c54c0065>${ssrInterpolate(((_f = _ctx.friendDetails) == null ? void 0 : _f.status) || "offline")}</span></div></div></div><div class="p-4 border-b border-gray-200" data-v-c54c0065><div class="flex justify-between items-center mb-3" data-v-c54c0065><h3 class="text-black font-medium" data-v-c54c0065> Attachments <span class="text-gray-500 text-sm" data-v-c54c0065>(${ssrInterpolate(attachments.value.length)})</span></h3><button class="text-sm text-blue-500 hover:underline" data-v-c54c0065> View All </button></div><div class="relative" data-v-c54c0065>`);
      if (isLoading.value) {
      ...
      if (attachments.value.length === 0 && !isLoading.value) {
        ...
        ssrRenderList(attachments.value.slice(0, 5), (attachment) => {
          ...
          if (isImage(attachment.mime_type)) {
            _push(`<div class="w-10 h-10 rounded-md overflow-hidden bg-gray-200" data-v-c54c0065><img${ssrRenderAttr("src", attachment.url)}${ssrRenderAttr("alt", attachment.filename)} class="w-full h-full object-cover" data-v-c54c0065></div>`);
          } else {
          ...
          _push(`</div><div class="flex-grow min-w-0" data-v-c54c0065><p class="text-sm font-medium truncate" data-v-c54c0065>${ssrInterpolate(attachment.filename)}</p><p class="text-xs text-gray-500" data-v-c54c0065>${ssrInterpolate(unref(formatFileSize)(attachment.size))}</p></div><div class="ml-2 flex" data-v-c54c0065><button class="p-1 text-gray-500 hover:text-blue-500" title="Download" data-v-c54c0065>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "fa:download",
            class: "h-4 w-4"
          }, null, _parent));
      ...
      if (showAttachmentsModal.value) {
        ...
        _push(`</button></div><div class="overflow-y-auto p-4" style="${ssrRenderStyle({ "max-height": "calc(90vh - 8rem)" })}" data-v-c54c0065>`);
        if (isLoadingMore.value) {
        ...
        ssrRenderList(attachments.value, (attachment) => {
          ...
          if (isImage(attachment.mime_type)) {
            _push(`<div class="w-12 h-12 rounded-md overflow-hidden bg-gray-200" data-v-c54c0065><img${ssrRenderAttr("src", attachment.url)}${ssrRenderAttr("alt", attachment.filename)} class="w-full h-full object-cover" data-v-c54c0065></div>`);
          } else {
          ...
          _push(`</div><div class="flex-grow min-w-0" data-v-c54c0065><p class="text-sm font-medium truncate" data-v-c54c0065>${ssrInterpolate(attachment.filename)}</p><p class="text-xs text-gray-500" data-v-c54c0065>${ssrInterpolate(unref(formatFileSize)(attachment.size))}</p><p class="text-xs text-gray-400" data-v-c54c0065>${ssrInterpolate(new Date(attachment.uploaded_at).toLocaleDateString())}</p></div><div class="ml-2 flex" data-v-c54c0065><button class="p-2 text-gray-500 hover:text-blue-500" title="Download" data-v-c54c0065>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "fa:download",
            class: "h-4 w-4"
          }, null, _parent));
        ...
        _push(`<!--]--></div>`);
        if (pagination.value.has_more_pages) {
          _push(`<div class="flex justify-center mt-4" data-v-c54c0065><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:bg-gray-300"${ssrIncludeBooleanAttr(isLoadingMore.value) ? " disabled" : ""} data-v-c54c0065>${ssrInterpolate(isLoadingMore.value ? "Loading..." : "Load More")}</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      ...
      if (showShareModal.value) {
        ...
        if (selectedAttachment.value) {
          ...
          _push(`</div></div><div data-v-c54c0065><p class="text-sm font-medium" data-v-c54c0065>${ssrInterpolate(selectedAttachment.value.filename)}</p><p class="text-xs text-gray-500" data-v-c54c0065>${ssrInterpolate(unref(formatFileSize)(selectedAttachment.value.size))}</p></div></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        ssrRenderList(friendsList.value, (friend) => {
          ...
          if (friend.avatar || friend.profile_picture_url) {
            _push(`<img${ssrRenderAttr("src", friend.avatar || friend.profile_picture_url)}${ssrRenderAttr("alt", friend.name)} class="h-full w-full object-cover" data-v-c54c0065>`);
          } else {
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:user",
              class: "h-4 w-4 text-gray-500"
          ...
          _push(`</div><span class="text-sm" data-v-c54c0065>${ssrInterpolate(friend.name)}</span></div>`);
          if (friend.shareSelected) {
        ...
        _push(`<!--]--></div></div><div class="flex justify-end" data-v-c54c0065><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(!friendsList.value.some((friend) => friend.shareSelected)) ? " disabled" : ""} data-v-c54c0065> Share </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showPreview.value && selectedAttachment.value) {
        ...
        if (isImage(selectedAttachment.value.mime_type)) {
          _push(`<img${ssrRenderAttr("src", selectedAttachment.value.url)}${ssrRenderAttr("alt", selectedAttachment.value.filename)} class="max-h-[80vh] max-w-full object-contain" data-v-c54c0065>`);
        } else {
          ...
          _push(`</div><h3 class="text-lg font-medium text-gray-900 mb-2" data-v-c54c0065>${ssrInterpolate(selectedAttachment.value.filename)}</h3><p class="text-sm text-gray-500 mb-4" data-v-c54c0065>${ssrInterpolate(unref(formatFileSize)(selectedAttachment.value.size))}</p><p class="text-sm text-gray-600" data-v-c54c0065> This file type cannot be previewed </p></div>`);
        }
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="${ssrRenderClass(bubbleClasses.value)}"${ssrRenderAttr(
        "title",
      ...
      if (_ctx.message.attachment) {
        ...
        if (_ctx.message.attachment.type === "image") {
          _push(`<img${ssrRenderAttr("src", _ctx.message.attachment.url)}${ssrRenderAttr("alt", _ctx.message.attachment.name)} class="max-w-full h-auto rounded cursor-pointer hover:opacity-90 transition-opacity max-h-48" data-v-4d2ec189>`);
        } else {
          _push(`<button${ssrIncludeBooleanAttr(isDownloading.value) ? " disabled" : ""} class="text-blue-500 hover:underline flex items-center space-x-1 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-xs"${ssrRenderAttr("title", `Download ${_ctx.message.attachment.name}`)} data-v-4d2ec189>`);
          ...
          _push(`<span class="text-xs truncate max-w-32" data-v-4d2ec189>${ssrInterpolate(_ctx.message.attachment.name)}</span>`);
          if (!isDownloading.value) {
            _push(ssrRenderComponent(_component_Icon, {
              name: "fa:download",
      ...
      _push(`<div data-v-4d2ec189><p class="text-sm break-words whitespace-pre-wrap" data-v-4d2ec189>${ssrInterpolate(_ctx.message.isDeleted ? "This message was deleted" : _ctx.message.content || "(No message content)")}</p>`);
      if (_ctx.message.failed && _ctx.message.errorMessage) {
        _push(`<p class="text-xs text-red-300 mt-1 italic" data-v-4d2ec189>${ssrInterpolate(_ctx.message.errorMessage)}</p>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (_ctx.message.failed) {
        ...
        if (_ctx.message.retryCount && _ctx.message.retryCount > 0) {
          _push(`<span data-v-4d2ec189> (${ssrInterpolate(_ctx.message.retryCount)}) </span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</span>`);
      ...
      _push(`<span class="text-xs opacity-75" data-v-4d2ec189>${ssrInterpolate(formattedTimestamp.value)}</span>`);
      if (_ctx.message.isCurrentUser) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full flex bg-gray-50" }, _attrs))} data-v-b6946581><div class="flex-1 flex flex-col h-full" data-v-b6946581><div class="px-6 py-4 bg-white border-b border-gray-200 flex items-center justify-between" data-v-b6946581><div class="flex items-center" data-v-b6946581><div class="relative mr-3" data-v-b6946581><div class="h-12 w-12 rounded-full overflow-hidden bg-gray-200 flex-shrink-0 flex items-center justify-center" data-v-b6946581>`);
      if (validatedRecipientAvatar.value) {
        _push(`<img${ssrRenderAttr("src", validatedRecipientAvatar.value)}${ssrRenderAttr("alt", recipient.value.name)} class="h-full w-full object-cover" data-v-b6946581>`);
      } else {
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:user",
      ...
      _push(`</div><div data-v-b6946581><h2 class="font-semibold text-gray-800" data-v-b6946581>${ssrInterpolate(recipient.value.first_name)} ${ssrInterpolate(recipient.value.last_name)}</h2><p class="text-xs text-gray-500" data-v-b6946581>${ssrInterpolate(recipient.value.status === "online" ? "Online" : "Offline")} `);
      if (isTyping.value) {
      ...
      _push(`</button><button class="${ssrRenderClass([{ "text-blue-500": showInfo.value }, "p-2 rounded-md text-gray-500 hover:bg-gray-100 hover:text-blue-500 transition-colors duration-200"])}" title="View info" data-v-b6946581>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "fa:info-circle",
        class: "h-4 w-4"
      }, null, _parent));
      ...
      _push(`<!--[-->`);
      ssrRenderList(groupedMessages.value, (group) => {
        _push(`<div class="message-group" data-v-b6946581><div class="flex justify-center my-4" data-v-b6946581><div class="bg-gray-100 rounded-full px-3 py-1" data-v-b6946581><span class="text-xs text-gray-600 font-medium" data-v-b6946581>${ssrInterpolate(group.isToday ? "Today" : group.isYesterday ? "Yesterday" : group.date)}</span></div></div><!--[-->`);
        ssrRenderList(group.messages, (message) => {
          _push(ssrRenderComponent(ChatAreaItem, {
            key: message.id,
            message: {
              ...message,
      ...
      if (isUploading.value && uploadProgress.value.length > 0) {
        _push(`<div class="mb-3" data-v-b6946581><div class="text-sm text-gray-600 mb-2" data-v-b6946581> Uploading ${ssrInterpolate(uploadProgress.value.length)} file(s)... </div><div class="space-y-2" data-v-b6946581><!--[-->`);
        ssrRenderList(uploadProgress.value, (progress) => {
          _push(`<div class="flex items-center space-x-3" data-v-b6946581><div class="flex-1" data-v-b6946581><div class="flex justify-between text-xs text-gray-600 mb-1" data-v-b6946581><span data-v-b6946581>${ssrInterpolate(progress.file.name)}</span><span data-v-b6946581>${ssrInterpolate(progress.progress)}%</span></div><div class="w-full bg-gray-200 rounded-full h-2" data-v-b6946581><div class="${ssrRenderClass([{
            "bg-blue-500": progress.status === "uploading",
            "bg-green-500": progress.status === "success",
            "bg-red-500": progress.status === "error",
            "bg-gray-300": progress.status === "pending"
          }, "h-2 rounded-full transition-all duration-300"])}" style="${ssrRenderStyle({ width: `${progress.progress}%` })}" data-v-b6946581></div></div>`);
          if (progress.error) {
            _push(`<div class="text-xs text-red-500 mt-1" data-v-b6946581>${ssrInterpolate(progress.error)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
      ...
      _push(`<form class="flex flex-col" data-v-b6946581><div class="flex items-center" data-v-b6946581><div class="relative" data-v-b6946581><button type="button" class="${ssrRenderClass([{ "bg-blue-100 text-blue-600": isAttachmentMenuOpen.value }, "p-2 rounded-full text-gray-500 hover:bg-gray-100 hover:text-blue-500 transition-colors duration-200 mr-2"])}" title="Attach file"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-b6946581>`);
      if (isUploading.value) {
        _push(ssrRenderComponent(_component_Icon, {
          name: "svg-spinners:270-ring",
          class: "h-5 w-5"
      ...
      _push(`</button>`);
      if (isAttachmentMenuOpen.value) {
        _push(`<div class="absolute bottom-12 left-0 bg-white border border-gray-200 rounded-lg shadow-lg p-2 z-10 animate-fadeIn" style="${ssrRenderStyle({ "min-width": "150px" })}" data-v-b6946581><button type="button" class="flex items-center text-gray-700 hover:bg-blue-50 hover:text-blue-600 mb-2 w-full text-left px-4 py-2 rounded transition-all duration-200"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-b6946581>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:file",
          class: "mr-2"
        }, null, _parent));
        ...
        _push(`</button><button type="button" class="flex items-center text-gray-700 hover:bg-blue-50 hover:text-blue-600 w-full text-left px-4 py-2 rounded transition-all duration-200"${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-b6946581>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa:image",
          class: "mr-2"
        }, null, _parent));
      ...
      _push(`</div><input type="file" class="hidden" multiple${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-b6946581><input type="file" accept="image/*" class="hidden" multiple${ssrIncludeBooleanAttr(isSending.value || isUploading.value) ? " disabled" : ""} data-v-b6946581>`);
      if (isSending.value) {
      ...
      _push(`<input${ssrRenderAttr("value", inputMessage.value)} type="text"${ssrRenderAttr(
        "placeholder",
        editingMessageId.value ? "Edit your message..." : "Type your message..."
      )} class="flex-1 py-2 px-4 rounded-full border border-gray-300 focus:outline-none focus:border-blue-400 text-gray-700"${ssrIncludeBooleanAttr(isSending.value) ? " disabled" : ""} data-v-b6946581><button type="submit" class="bg-blue-500 text-white p-3 rounded-full ml-2 hover:bg-blue-600 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(
      ...
      if (unref(webSocketStore).isConnected) {
      ...
      } else if (unref(webSocketStore).isConnecting) {
      ...
      if (unref(webSocketStore).connectionError) {
        _push(`<span class="text-xs text-red-500 ml-2"${ssrRenderAttr("title", unref(webSocketStore).connectionError)} data-v-b6946581>${ssrInterpolate(getConnectionErrorMessage())}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></form></div></div>`);
      if (showInfo.value) {
        _push(ssrRenderComponent(FriendInfoPanel, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full flex flex-col w-full" }, _attrs))}>`);
      if (!isGroup.value) {
        _push(ssrRenderComponent(ChatArea, {
          recipientId: recipientId.value,
          recipientName: ((_a = chatDetails.value) == null ? void 0 : _a.name) || recipientId.value,
          chatMessages: chatMessages.value
        }, null, _parent));
      } else {
        _push(ssrRenderComponent(GroupChatArea, {
...
//# sourceMappingURL=_id_-cUgA7fc8.mjs.map

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-4b6f0a29><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-4b6f0a29></div><div class="max-w-520px text-center" data-v-4b6f0a29><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-4b6f0a29>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-4b6f0a29>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
//# sourceMappingURL=error-500-BuYOuWNQ.mjs.map

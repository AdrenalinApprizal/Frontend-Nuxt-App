...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CkgKCQBs.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-DmjrHgh0.mjs')
  },
  {
    name: "chat-groups",
    path: "/chat/groups",
    component: () => import('./groups-Bdfyk0sa.mjs'),
    children: [
      {
        name: "chat-groups-id",
        path: ":id()",
        component: () => import('./_id_-Dyqo8aXn.mjs')
      }
    ]
  },
  {
    name: "chat-friends",
    path: "/chat/friends",
    component: () => import('./friends-D6cDy8Lz.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import('./register-C6Q7Q8QW.mjs')
  },
  {
    name: "chat-messages",
    path: "/chat/messages",
    meta: { "middleware": ["auth"] },
    component: () => import('./messages-NqY8Yepn.mjs'),
    children: [
      {
        name: "chat-messages-id",
        path: ":id()",
        component: () => import('./_id_-wkPnpng_.mjs')
      }
    ]
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vueExports.defineAsyncComponent(() => import('./error-404-Ct2Vj38O.mjs'));
    const _Error = vueExports.defineAsyncComponent(() => import('./error-500-CDMUpPfK.mjs'));
